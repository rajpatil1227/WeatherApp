...
int main()
{
    ...
    int choice, v, pos;
    char b[50];
    strcpy(sp[1].name, "Ram");
    strcpy(sp[1].num, "6377834657");
    strcpy(sp[1].mail, "ram@gmail.com");
    i++;

    strcpy(sp[2].name, "Sham");
    strcpy(sp[2].num, "6746786567");
    strcpy(sp[2].mail, "sham@gmail.com");
    i++;

    strcpy(sp[3].name, "Raju");
    strcpy(sp[3].num, "2983983893");
    strcpy(sp[3].mail, "raju@gmail.com");
    i++;

    strcpy(sp[4].name, "Gabber");
    strcpy(sp[4].num, "3675576754");
    strcpy(sp[4].mail, "gabber@gmail.com");
    i++;

    strcpy(sp[5].name, "Rocky");
    strcpy(sp[5].num, "6752348972");
    strcpy(sp[5].mail, "rocky@gmail.com");
    i++;
